...
// ===== qna 라우트 연결 =====
const registerQnaRoutes = require('./public/js/qna.js');
...
// ===== 시나리오 라우트 연결 =====
const registerScenarioRoutes = require("./public/js/scenario.js");
registerScenarioRoutes(app);

// ===== 실시간 기능 연결 =====
const registerRealtime = require("./public/js/realtime.js");
...
// ===== 뉴스 라우트 연결 =====
const registerNews = require("./public/js/news.js");
registerNews(app, newsDbConnection);

// ===== 리포트 라우트 연결 =====
const registerReport = require("./public/js/report.js");
registerReport(app);

// ===== 보유자산(마이페이지) 라우트 연결 =====
const registerHoldings = require("./services/holdings");
registerHoldings(app);
app.use('/mypage.js', express.static(path.join(__dirname, 'public/js/mypage.js')));
